...
router.register('completed-sales', views.CompletedSaleViewSet, basename='completedsales-list')
...
salesperson_router.register(r'sales', views.SaleViewSet, basename='salesperson-sales')
